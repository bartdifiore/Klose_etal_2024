#--------------------------------
## Fit Full Stan latent variable model WITH HURDLE COMPONENT (wintercept v2)
## Using rstan
...
model <- stan_model("Code/stream_quality_full_hurdle_wintercept_v2.stan")
...
saveRDS(fit, file = "Models/stan_model_full_hurdle_wintercept_v2_fit.rds")

# Save summary
summary_df <- as.data.frame(summary(fit)$summary)
write.csv(summary_df, "Models/stan_model_full_hurdle_wintercept_v2_summary.csv", row.names = TRUE)

cat("\nModel fitting complete!\n")
cat("Model saved to: Models/stan_model_full_hurdle_wintercept_v2_fit.rds\n")
cat("Summary saved to: Models/stan_model_full_hurdle_wintercept_v2_summary.csv\n")
